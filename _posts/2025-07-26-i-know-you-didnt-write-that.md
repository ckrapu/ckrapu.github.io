...
Perhaps it was an awesome auth middleware that you vibe coded last night. It could have been a work plan to get into Carnegie Mellon, produced by the hottest new college admissions AI. Maybe it was even a message that was supposed to be heartfelt and deeply personal, but instead got mangled through 26 TFLOPs of DeepSeek.
...
I know that you didn't write that. I know it was touched by an AI, and you aren't sneaky enough to fool me. I've been digesting LLM outputs by the megatoken since I first got off the GPT-3 API waitlist in '21. I spend $700 a month on 10+ pro memberships (Claude Max is the darling right now, but that won't last forever) and 50% of my job is understanding how all of the major players' models respond to an insanely wide and unfairly difficult set of test queries and tasks on our company's internal AI platform.
...
{% include important-box.liquid content="Here, I do need to specify a few small caveats. If we're working in English and it's clearly your  (or third, or fourth and so on) language, I understand that you want the substance of the message to shine despite its style. I'll cut you a break. I will hold my nose despite all the text smells because I genuinely want to see your work in the best light possible. I also empathize with those who have physical issues and disabilities preventing them from hunching over a computer and mashing the keyboard for hours at a time. If you fall into either of these categories, please ignore my previous hyperbole." %}

Am I a Luddite? A bit, perhaps. I really an LLM enthusiast, though sadly, my local deployment can only handle models sized at 8B or less. I want you to vibe code like a lunatic. I want you to grill Opus 4 on O(N) methods for approximating the middle eigenvalues of a sparse positive matrix. Have it write RISC-V assembly for a Gibbs sampler. Honestly, I want you do some crazy stuff.
